...
<div class="page-content">
    ...
    <div class="subj-info phetsarath">
        <div class="subj-name phetsarath">ວິຊາເສັງ : <?=$quiz_info['subj_name']?></div>
        <div class="phetsarath">ຫົວຂໍ້ສອບເສັງ : <?=$quiz_info['quiz_title']?></div>
    ...
    <div class="action-btn center">
        ...
        <button onclick="start_exam('<?=$user_data['id']?>','<?=$quiz_info['class_quiz_id']?>','<?=$quiz_id?>','<?=$quiz_info['subj_name']?>','<?=$quiz_info['quiz_title']?>','<?=$quiz_info['quiz_time']?>')" type="button" class="btn btn-success phetsarath">ເລີ່ມຕົ້ນສອບເສັງ</button>
        <button type="button" class="btn btn-danger phetsarath">ຍົກເລີກ</button>
    </div>
</div>
