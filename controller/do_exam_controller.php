<?php
    ...
    if(isset($_POST['start_exam'])){
        ...
        $insert_sql .="INSERT INTO test_quiz(test_number, subj_name, quiz_title, start_time, submit_time, user_id, class_quiz_id, status) VALUES 
        ('".$test_number."', '".$data->subj_name."', '".$data->quiz_title."', '".date("Y-m-d H:i:s")."', NULL, '".$data->user_id."', '".$data->class_quiz_id."', 1);";
