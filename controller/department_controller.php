<?php
    ...
    function load_data(){
        global $dbcon;
        $sql = "SELECT dep_id,dep_name,user_id,dep_status,last_update,(SELECT COUNT(*) FROM users u WHERE u.dep_id = d.dep_id)'member' FROM departments d WHERE dep_status = 1";
