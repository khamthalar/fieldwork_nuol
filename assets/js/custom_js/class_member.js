                    ...
                    if(el.classroom_id==null){
                        ...
                        class_data.forEach(classroom=>{
                            if(classroom.classroom_id==el.classroom_id){
                                ...
                                row_str +=`<button onclick="set_classroom('`+encode(JSON.stringify(param))+`')" type="button" class="btn btn-secondary btn-icon-text btn-rounded none-select none-outline mr-1">
                                `+classroom.classroom_des+`</button>`;
                            }
                        });
                        row_str +=`</td></tr>`;
                    ...
                    if(el.classroom_id!=null){
                        ...
                        class_data.forEach(classroom=>{
                            if(classroom.classroom_id==el.classroom_id){
                                ...
                                row_str +=`<button onclick="set_classroom('`+encode(JSON.stringify(param))+`',`+classroom.classroom_id+`)" type="button" class="btn btn-secondary btn-icon-text btn-rounded none-select none-outline mr-1">
                                `+classroom.classroom_des+`</button>`;
                            }
                        });
                        row_str +=`</td></tr>`;
...
function set_classroom(selectedData,classroom_id){
    let data = decode(selectedData);
