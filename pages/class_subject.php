<?php
require_once "controller/classroom_subj_controller.php";
...
<div class="header-page">
  <div class="page-title">
    <h5 class="phetsarath"><a href="template?page=home" class="home-link">ໜ້າຫຼັກ</a> <i class="fas fa-chevron-right"></i> <a href="template?page=classroom" class="home-link">ຫ້ອງເສັງ</a> <i class="fas fa-chevron-right"></i> ວິຊາເສັງ</h5>
  </div>
</div>
<div class="page-wrapper">
  <div class="content-wrapper">
    <?php
      ...
      $data = load_data($_GET['class_id'])->fetchAll(PDO::FETCH_ASSOC);
    ?>
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="cus-card card">
          <div class="card-body">
            <h4 class="card-title phetsarath">ຂໍ້ມູນຫ້ອງວິຊາເສັງ (<?=isset($_GET['class_des'])?$_GET['class_des']:''?>)</h4>
            <div class="top-content">
              <div>
                <button type="button" onclick="window.location.href='template?page=classroom&sub_page=select_class<?=@$class_id_param.@$class_des_param?>'" class="btn-newclass btn btn-primary btn-icon-text none-select none-outline phetsarath">
                  <i class="ti-import"></i>
                </button>
              </div>
              ...
              <div class="paginate">
                <?php
                $current_page = 1;
                $row_num = load_data($_GET['class_id'])->rowCount();
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <td class="col-id"><?=$data[$i]['subject_id']?></td>
