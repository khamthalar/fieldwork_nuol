                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <button onclick="window.location.href='template?page=subject&sub_page=quiz&subj_id=<?=$data[$i]['subj_id']?>&subj_name=<?=$data[$i]['subj_name']?>'"  type="button" class="btn btn-primary btn-icon-text btn-rounded none-select none-outline" id="log">
                          <i class="fas fa-solid fa-scroll"></i> <?=$data[$i]['quiz_num']?>
                        </button>
                        <?php
                          $quiz_num = intval($data[$i]['quiz_num']);
                          if($quiz_num==0){
                            ?>
