...
<div class="header-page">
  <div class="page-title">
    <h5 class="notosans"><a href="template?page=home" class="home-link">ໜ້າຫຼັກ</a> <i class="fas fa-chevron-right"></i> ກຸ່ມຜູ້ໃຊ້ງານລະບົບ</h5>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="cus-card card">
          <div class="card-body">
            <h4 class="card-title notosans">ຂໍ້ມູນກຸ່ມຜູ້ໃຊ້ງານລະບົບ</h4>
            <div class="top-content">
              <div class="top-act">
                <?php if($permission['manage_user_group']){ ?>
                <button type="button" class="btn-newclass btn btn-primary btn-icon-text none-select none-outline notosans" data-bs-toggle="modal" data-bs-target="#add_user_group" data-bs-backdrop="static">
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th class="notosans">ກຸ່ມຜູ້ໃຊ້ງານລະບົບ</th>
                    <th class="notosans">ສະມາສິກ</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="notosans"><?=htmlspecialchars_decode($user_group[$i]['group_des'],ENT_QUOTES)?></td>
                      <td class="notosans"><i class="fas fa-solid fa-user"></i> <?=$user_group[$i]['member']?></td>
                      <td>
                        <?php 
