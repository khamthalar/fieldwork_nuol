...
<div class="header-page">
  <div class="page-title">
    <h5 class="phetsarath">
      ...
      <a href="template?page=subject&sub_page=quiz_preview&quiz_id=<?=$quiz_id?>&quiz_title=<?=$quiz_title?>&subj_id=<?=$subj_id?>&subj_name=<?=$subj_name?>" class="home-link">ລາຍລະອຽດຫົວຂໍ້ເສັງ</a> <i class="fas fa-chevron-right"></i>
      ເລືອກຄໍາຖາມສອບເສັງ
    </h5>
  </div>
</div>
