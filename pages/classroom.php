...
<div class="header-page">
  <div class="page-title">
    <h5 class="notosans"><a href="template?page=home" class="home-link">ໜ້າຫຼັກ</a> <i class="fas fa-chevron-right"></i> ຫ້ອງເສັງ</h5>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="cus-card card">
          <div class="card-body">
            <h4 class="card-title notosans">ຂໍ້ມູນຫ້ອງສອບເສັງ</h4>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="notosans"><?=$data[$i]['class_des']?></td>
                      <td>
                        ...
                        <button onclick="window.location.href='template?page=classroom&sub_page=class_member&class_id=<?=$data[$i]['id']?>&class_des=<?php echo htmlspecialchars($data[$i]['class_des'],ENT_QUOTES, 'UTF-8'); ?>';" type="button" class="btn btn-primary btn-icon-text btn-rounded none-select none-outline">
                          ...
                          <button onclick="window.location = 'template?page=classroom&sub_page=class_subject&class_id=<?=$data[$i]['id']?>&class_des=<?php echo htmlspecialchars($data[$i]['class_des'],ENT_QUOTES, 'UTF-8'); ?>';"  type="button" class="btn btn-secondary btn-icon-text btn-rounded none-select none-outline" id="log">
                            <i class="ti-book btn-icon-prepend"></i><?=$data[$i]['subj_num']?>
                          </button>
