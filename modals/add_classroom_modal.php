<div class="modal fade" id="addclass" tabindex="-1" role="dialog" aria-labelledby="addclass">
    ...
    <div class="modal-content">
            <div class="modal-header" 
                ...
                <h4 class="modal-title notosans" id="addclass">ເພີ່ມຫ້ອງເສັງໃໝ່</h4>
            ...
            <form method="POST" action="">
                ...
                <div class="modal-footer" style="justify-content:center;">
                    <button type="submit" name="new_class" class="cus-btn btn btn-primary btn-icon-text notosans none-outline none-select">
                        ບັນທຶກ
