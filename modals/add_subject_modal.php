<div class="modal fade" id="addsubject" tabindex="-1" role="dialog" aria-labelledby="addsubject">
    ...
    <div class="modal-content">
            <div class="modal-header" 
                ...
                <h4 class="modal-title notosans" id="addclass">ເພີ່ມວິຊາເສັງໃໝ່</h4>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="subj_name" class="notosans">ກະລຸນາປ້ອນຊື່ວິຊາ</label>
                        <input type="text" class="form-control notosans center none-select none-outline" id="subj_name" name="subj_name" required>
                    </div>
                    
                </div>
                <div class="modal-footer" style="justify-content:center;">
                    <button type="submit" name="new_subject" class="cus-btn btn btn-primary btn-icon-text notosans none-outline none-select">
                        ບັນທຶກ
