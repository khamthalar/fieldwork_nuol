<div class="modal fade" id="editdepartment" tabindex="-1" role="dialog" aria-labelledby="editdepartment">
    ...
    <div class="modal-content">
            <div class="modal-header" 
                ...
                <h4 class="modal-title notosans" id="addclass">ແກ້ໄຂຂໍ້ມູນພະແນກ</h4>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="dep_name" class="notosans">ກະລຸນາປ້ອນຊື່ພະແນກ</label>
                ...
                <div class="modal-footer" style="justify-content:center;">
                    <button type="submit" name="update_department" class="cus-btn btn btn-primary btn-icon-text notosans none-outline none-select">
                        ບັນທຶກ
