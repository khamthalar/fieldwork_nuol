<div class="modal fade" id="update_usergroup" tabindex="-1" role="dialog" aria-labelledby="update_usergroup">
    ...
    <div class="modal-content">
            <div class="modal-header" 
                ...
                <h4 class="modal-title notosans" id="addclass">ເລືອກກຸ່ມຜູ້ໃຊ້ງານລະບົບ</h4>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-select notosans" aria-label="Default select" name="user_group_id" id="user_group">
                        </select>
                    </div>
                </div>
                <div class="modal-footer" style="justify-content:center;">
                    <button type="submit" name="update_usergroup" class="cus-btn btn btn-primary btn-icon-text notosans none-outline none-select">
                        ບັນທຶກ
