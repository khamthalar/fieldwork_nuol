<div class="modal fade" id="update_pwd" tabindex="-1" role="dialog" aria-labelledby="update_pwd">
    ...
    <div class="modal-content">
            <div class="modal-header" 
                ...
                <h4 class="modal-title notosans" id="addclass">ຕັ້ງລະຫັດຜ່ານໃໝ່</h4>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="subj_name" class="notosans">ກະລຸນາປ້ອນລະຫັດຜ່ານໃໝ່</label>
                        <input type="text" name="u_id" id="u_id" hidden>
                        <input type="password" class="form-control notosans center none-select none-outline" id="password" name="password" value="edlquiz" required>
                    </div>
                    
                </div>
                <div class="modal-footer" style="justify-content:center;">
                    <button type="submit" name="update_pwd" class="cus-btn btn btn-primary btn-icon-text notosans none-outline none-select">
                        ບັນທຶກ
