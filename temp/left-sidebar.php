    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#department" aria-expanded="false" aria-controls="department">
          ...
          <span class="menu-title phetsarath f12">ຂໍ້ມູນພະແນກ</span>
          <i class="menu-arrow"></i>
        </a>
        <div class="collapse" id="department">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link phetsarath f12" href="template?page=department">ຂໍ້ມູນພະແນກ</a></li>
            <li class="nav-item"> <a class="nav-link phetsarath f12" href="template?page=employee">ຂໍ້ມູນພະນັກງານ</a></li>
          </ul>
        </div>
      </li>
	  <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
          ...
          <span class="menu-title phetsarath f12">ຂໍ້ມູນວິຊາສອບເສັງ</span>
          <i class="menu-arrow"></i>
        </a>
        <div class="collapse" id="form-elements">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link phetsarath f12" href="template?page=subject">ວີຊາເສັງ</a></li>
            <li class="nav-item"><a class="nav-link phetsarath f12" href="template?page=question">ຄໍາຖາມ</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="setting">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link phetsarath f12" href="template?page=open_exam">ເປີດສອບເສັງ</a></li>
            <li class="nav-item"> <a class="nav-link phetsarath f12" href="template?page=quiz_overview">ກວດບົດເສັງ</a></li>
