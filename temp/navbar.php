<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo mr-1" href="template?page=home"><img style="height: 45px;" src="assets/svg/nuol_ico_1.svg" class="mr-2" alt="logo"/></a>
      <a class="navbar-brand brand-logo-mini" href="template?page=home"><img style="height: 45px; width:50px;" src="assets/svg/nuol_ico.svg" alt="logo"/></a>
    </div>
